...
<div class="form-card">
    ...
    <?php if (empty($form) || empty($form['id'])): ?>
        <p>Невірний ідентифікатор співробітника.</p>
    <?php else: ?>
        <form method="post" action="/db-lab/public/index.php?r=employee/update&id=<?= (int)$form['id'] ?>">
            ...
            <div style="margin-top: 10px; display:flex; gap:8px;">
                ...
                <a href="/db-lab/public/index.php?r=employee/index" class="btn">Скасувати</a>
            </div>
        </form>
    <?php endif; ?>
</div>
